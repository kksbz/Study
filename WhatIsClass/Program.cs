...
namespace WhatIsClass
{
    internal class Program
    {
        ...
        //1. 명함(BusinessCard)이라는 구조체 선언 및 초기화 해보기
        //이름, 나이, 주소
        ...
        enum Weekday
        {
            SUNDAY, MONDAY, TUESDAY, WEDNESDAY, THURSDAY, FURIDAY, SATURDAY
        }
        ...
        {
            //1번 struct BusinessCard 안에 선언된 데이터형식들을 불러와서 사용함
            BusinessCard card;
            card.name = "김모씨";
            card.age = 105;
            card.address = "제주";
            Console.WriteLine("이름: {0}, 나이: {1}, 주소: {2}",card.name, card.age, card.address);
            ...
            */
            ...
            //point.y = 200;
            //point.myname = "kks";
            //Console.WriteLine("x좌표 y좌표는 ({0},{1})입니다.",point.x,point.y);
             ...
             */
            //Console.WriteLine("DateTime now하면 뭐가 나오나? -> {0}", DateTime.Now);
            //Console.WriteLine("DateTime now하면 뭐가 나오나? -> {0}", DateTime.Now.Year);
            //Console.WriteLine("DateTime now하면 뭐가 나오나? -> {0}", DateTime.Now.Month);
            //Console.WriteLine("DateTime now하면 뭐가 나오나? -> {0}", DateTime.Now.Day);
            //Console.WriteLine("DateTime now하면 뭐가 나오나? -> {0}", DateTime.Now.Hour);
            //Console.WriteLine("DateTime now하면 뭐가 나오나? -> {0}", DateTime.Now.Minute);
            //Console.WriteLine("DateTime now하면 뭐가 나오나? -> {0}", DateTime.Now.Second);
            ...
            //Console.WriteLine("qwebq");
            //Console.ResetColor();

            //구조체랑 사용방식은 비슷하지만 내용은 다름
            //Weekday myWeekday;
